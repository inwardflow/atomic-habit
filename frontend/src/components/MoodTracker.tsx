...
const MOODS = [
    { id: 'MOTIVATED', label: 'Motivated', icon: Zap, color: 'text-yellow-500', bg: 'bg-yellow-50 dark:bg-yellow-900/20' },
    { id: 'FOCUSED', label: 'Focused', icon: Target, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
    { id: 'HAPPY', label: 'Happy', icon: Smile, color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
    { id: 'NEUTRAL', label: 'Neutral', icon: Minus, color: 'text-gray-500', bg: 'bg-gray-50 dark:bg-gray-800' },
    { id: 'TIRED', label: 'Tired', icon: BatteryLow, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
    { id: 'SAD', label: 'Sad', icon: CloudRain, color: 'text-indigo-400', bg: 'bg-indigo-50 dark:bg-indigo-900/20' },
    { id: 'ANXIOUS', label: 'Anxious', icon: Wind, color: 'text-orange-400', bg: 'bg-orange-50 dark:bg-orange-900/20' },
    { id: 'ANGRY', label: 'Frustrated', icon: Flame, color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/20' },
];
                ...
                {MOODS.map((mood) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="text-[10px] font-medium text-slate-600 dark:text-slate-300">{mood.label}</span>
                        </button>
                    );
                })}
            </div>
                    ...
                    >
                        <div className="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 border border-slate-100 dark:border-slate-700">
                            ...
                            <div className="flex justify-end gap-2">
                                ...
                                >
                                    {isSubmitting ? 'Saving...' : <>Save Check-in <Check size={12} /></>}
                                </button>
                            </div>
                        </div>
                    </motion.div>
